    ...
    <div class="row g-4">
        <div class="col-md-5">
            <div id="mainImageWrapper">
                <img id="mainImage" src="{{ asset('storage/' . $product->image) }}" class="img-fluid" alt="{{ $product->product_name }}">
            </div>
        </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-2" style="max-width: 200px;">
                            ...
                            <input type="number" name="quantity" id="quantityInput" value="1" min="1" max="{{ $product->quantity }}" class="form-control text-center px-1" style="width: 60px;">
                            <button class="btn btn-outline-secondary" type="button" onclick="changeQty(1)">+</button>
                        </div>
                    </div>
